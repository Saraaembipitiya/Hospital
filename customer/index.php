...
if($_SESSION['isAdmin'] === "true" ){
	return header("Location:/myproject/admin/index.php?hello='Wellcome dear admin'");
}}
                    ...
                    <div class="col-lg-7">
                        <div class="banner-content">
                            ...
                            <?php if(isset($_SESSION['UserName'])){
                               echo "<h1>Wellcome back ".$_SESSION['UserName']."</h1>";
                            }else
                            {
                                echo "<h1>You Wellcome for Arogya Hospital</h1> ";
                            }
                                ?>
        ...
        <div class="about-area pt-100 pb-70">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="assets/img/about-img/about-img.png" alt="Images">
                        </div>
                    </div>
