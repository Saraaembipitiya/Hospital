    ...
    <body>
        ...
        <div class="about-area pt-100 pb-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-content about-content-mr">
                            ...
                            <div class="about-btn">
                                <a href="#" class="default-btn-two">Explore More</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- About Area End -->
         ...
         <!-- Brand Area -->
         <div class="brand-area brand-bg2">
            <div class="container">
                ...
                <div class="row pt-45">
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item service-item-bg1">
                            ...
                            <h3>
                                <a href="service-details.html">Medical Counselling</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item service-item-bg2">
                            ...
                            <h3>
                                <a href="service-details.html">Laboratory Test</a>
                            </h3>
                            <p>We provide  wide range of medical counselling by the professional doctor & therapist.</p>
                            <div class="service-shape-1">
                                <img src="assets/img/services/service-shape1.png" alt="Images">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item service-item-bg3">
                            ...
                            <h3>
                                <a href="service-details.html">Surgical Operation</a>
                            </h3>
                            <p>We provide  wide range of medical counselling by the professional doctor & therapist.</p>
                            <div class="service-shape-1">
                                <img src="assets/img/services/service-shape1.png" alt="Images">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item service-item-bg4">
                            <a href="service-details.html" class="service-item-icon">
                                <i class="flaticon-stethoscope-1"></i>
                            </a>
                            <h3>
                                <a href="service-details.html">Medical Treatment</a>
                            </h3>
                            <p>We provide  wide range of medical counselling by the professional doctor & therapist.</p>
                            <div class="service-shape-1">
                                <img src="assets/img/services/service-shape1.png" alt="Images">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item service-item-bg5">
                            <a href="service-details.html" class="service-item-icon">
                                <i class="flaticon-caduceus-symbol"></i>
                            </a>
                            <h3>
                                <a href="service-details.html">Pharmacy Service</a>
                            </h3>
                            <p>We provide  wide range of medical counselling by the professional doctor & therapist.</p>
                            <div class="service-shape-1">
                                <img src="assets/img/services/service-shape1.png" alt="Images">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item service-item-bg6">
                            <a href="service-details.html" class="service-item-icon">
                                <i class="flaticon-ambulance-2"></i>
                            </a>
                            <h3>
                                <a href="service-details.html">Emergency Services</a>
                            </h3>
                            <p>We provide  wide range of medical counselling by the professional doctor & therapist.</p>
                            <div class="service-shape-1">
                                <img src="assets/img/services/service-shape1.png" alt="Images">
        ...
        <div class="prescription-area-two prescription-bg-2 ptb-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="prescription-content prescription-content-ml">
            ...
            <div class="prescription-shape-2">
        ...
        <div class="product-area pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    <h2>Visit Our Online Pharmacy</h2>
                </div>
                <div class="row pt-45">
            ...
            <div class="product-shape">
                <img src="assets/img/product/product-shape.png" alt="Images">
            </div>
        </div>
        <!-- Product Area End -->
        ...
        <div class="insurance-area">
            <div class="container">
                <div class="insurance-content">
                    <h2>Get Online Health Insurance</h2>
                    <p>Apply for Insurance online during this Corona Pandemic and secure your health. We are taking all documents in online.</p>
            ...
            <div class="insurance-img">
                <img src="assets/img/insurance-img.png" alt="Images">
            </div>
        </div>
        <!-- Insurance Area End -->
            ...
            <div class="container">
                ...
                <div class="row pt-45">
                    <div class="col-lg-4 col-md-6">
                        <div class="case-study-card">
                            <a href="case-details.html">
                                <img src="assets/img/case-study/case-study-1.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <h3><a href="case-details.html">Cancer Surviver</a></h3>
                                <p>We provide  wide range of medical counselling by the professional doctor & therapist. </p>
                                <a href="#" class="read-mor-btn">
                                    Read More
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="case-study-card">
                            <a href="case-details.html">
                                <img src="assets/img/case-study/case-study-2.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <h3><a href="case-details.html">Medical Surviver</a></h3>
                                <p>We provide  wide range of medical counselling by the professional doctor & therapist. </p>
                                <a href="#" class="read-mor-btn">
                                    Read More
                                    <i class="flaticon-right-arrow"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="case-study-card">
                            <a href="case-details.html">
                                <img src="assets/img/case-study/case-study-3.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <h3><a href="case-details.html">Surgical Operation</a></h3>
                                <p>We provide  wide range of medical counselling by the professional doctor & therapist. </p>
                                <a href="#" class="read-mor-btn">
                                    Read More
                                    <i class="flaticon-right-arrow"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="case-study-card">
                            <a href="case-details.html">
                                <img src="assets/img/case-study/case-study-4.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <h3><a href="case-details.html">Medical Treatment</a></h3>
                                <p>We provide  wide range of medical counselling by the professional doctor & therapist. </p>
                                <a href="#" class="read-mor-btn">
                                    Read More
                                    <i class="flaticon-right-arrow"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="case-study-card">
                            <a href="case-details.html">
                                <img src="assets/img/case-study/case-study-5.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <h3><a href="case-details.html">Heart Surgery</a></h3>
                                <p>We provide  wide range of medical counselling by the professional doctor & therapist. </p>
                                <a href="#" class="read-mor-btn">
                                    Read More
                                    <i class="flaticon-right-arrow"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="case-study-card">
                            <a href="case-details.html">
                                <img src="assets/img/case-study/case-study-6.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <h3><a href="case-details.html">Teeth Whitening</a></h3>
                                <p>We provide  wide range of medical counselling by the professional doctor & therapist. </p>
                                <a href="#" class="read-mor-btn">
                                    Read More
                                    <i class="flaticon-right-arrow"></i>
                    ...
                    <div class="col-lg-12">
                        <div class="case-study-more">
                            <a href="case-study.html" class="default-btn-two">
                                Explore More
                            </a>
                        </div>
                    </div>
