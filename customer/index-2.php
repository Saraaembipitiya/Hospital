...
<html lang="zxx">
    ...
    <body>
        ...
        <!-- Banner Area Two -->
        <div class="banner-area-two banner-bg-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner-content-two">
                            <span>The Home of Your Hope</span>
                            <h1>Our Hospital Has  Different Services for Every Patient</h1>
        ...
        <!-- Banner Bottom Two -->
        <div class="banner-bottom-two pb-70">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-content">
                                ...
                                <h3><a href="service-details.html">Emergency Services</a></h3>
                                <div class="content">
                                    <p>We provide  wide range of medical counselling by the professional doctor & therapist.</p>
                                </div>
                            </div>
